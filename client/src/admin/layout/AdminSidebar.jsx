...
function AdminSidebar({ open, setOpen }) {
  ...
  const currentPath = location.pathname; // e.g., "/admin/list-videos"
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static top-0 left-0 h-full w-72 bg-white shadow-xl border-r border-secondary z-50
      ...
      >
        ...
        <div className="border-b border-secondary p-5">
          <h1 className="font-headline text-primary text-2xl">
            Uchit Trader’s
          </h1>
        ...
        <nav className="p-4 space-y-3">
          ...
          <div
            className={linkClass("/admin/list-videos")}
            onClick={() => handleClick("/admin/list-videos")}
          >
            <FaVideo /> Videos
          </div>
